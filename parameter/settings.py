...
SECRET_KEY = 'django-insecure-jfaqjlb4$)zf)y*v#0hbs=#xsamrlrviz#yf(thka-!7_(qhmf'
...
INSTALLED_APPS = [
    ...
    'app_bulletin.apps.AppBulletinConfig',
    'app_staff.apps.AppStafConfig',
...
AUTHENTICATION_BACKENDS = ['app_auth.EmailBackend.EmailBackend']
